{  
  ...
  const sweetCoffeeMaker = new SweetCoffeeMaker(22, candySuger);
  const latteMachine = new CaffeLatteMachine(22, cheapMilkSteamer);
  const sweetCaffeLatteMachine = 
      new SweetCaffeLatteMachine(22, cheapMilkSteamer, candySuger);
