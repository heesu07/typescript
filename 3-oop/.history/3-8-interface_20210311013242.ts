{  
  ...
  const sweetCoffeeMaker1 = new CoffeeMachine(52, candySuger);
  const sweetCoffeeMaker2 = new CoffeeMachine(52, suger);
  const latteMachine = new CoffeeMachine(52, cheapMilkSteamer);
