{  
  ...
  class aaaCoffeeMachine extends CoffeeMachine {
    constructor(
  ...
  const sweetCoffeeMaker1 = new SweetCoffeeMaker(52, candySuger);
  const sweetCoffeeMaker2 = new SweetCoffeeMaker(52, suger);
  const latteMachine = new CaffeLatteMachine(52, cheapMilkSteamer);
  const sweetCaffeLatteMachine = new SweetCaffeLatteMachine(52, coldMilkSteamer, suger);
